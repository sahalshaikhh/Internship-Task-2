import { Tabs, Text, Title, Button } from "@mantine/core";
  ...
  return (
    <div className="  ec-w-full ec-items-center ec-justify-center ec-flex ec-p-5 lg:!ec-p-10 ec-flex-col ec-gap-7">
      ...
      >
        ...
        {TabsList.map((tab, index, button1, button2) => (
...
const Section3Card = ({ description, image, button1, button2 }) => {
  return (
    <div className="ec-w-full ec-flex ec-flex-col lg:ec-flex-row ec-items-center ec-justify-center ec-gap-5 ec-p-5">
      <div className="ec-w-full ec-flex ec-flex-col ec-gap-2">
        <Text className=" ec-text-lg md:ec-text-[22px]">{description}</Text>
        {/* Starting of Buttons */}
        <div className="button ec-flex ec-mt-12 ec-py-2 ec-space-x-10">
          <div className="preRegister">
            <Button
              className="Btn-1 ec-px-16"
              //   variant="light"
              //   color="gray"
              radius="md"
            >
